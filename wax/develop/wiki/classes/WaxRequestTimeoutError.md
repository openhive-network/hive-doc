[@hiveio/wax](../globals) / WaxRequestTimeoutError

# Class: WaxRequestTimeoutError\<T\>
...
### new WaxRequestTimeoutError()

> **new WaxRequestTimeoutError**\<`T`\>(`request`, `response`): [`WaxRequestTimeoutError`](./WaxRequestTimeoutError)\<`T`\>
...
[`WaxRequestTimeoutError`](./WaxRequestTimeoutError)\<`T`\>
...
[wasm/lib/detailed/healthchecker/errors.ts:57](https://gitlab.syncad.com/hive/wax/-/blob/ac1ac1931e32ec643b6bef7d6fee572aee5ac3b8/ts/wasm/lib/detailed/healthchecker/errors.ts#L57)
