[@hiveio/wax](../globals) / WaxCommunicationError

# Class: WaxCommunicationError
...
### new WaxCommunicationError()

> **new WaxCommunicationError**(`message`?, `source`?): [`WaxCommunicationError`](./WaxCommunicationError)
...
[`WaxCommunicationError`](./WaxCommunicationError)
...
[wasm/lib/detailed/errors.ts:17](https://gitlab.syncad.com/hive/wax/-/blob/c7c19535f1105a18799f3f0145049aea26c3115d/ts/wasm/lib/detailed/errors.ts#L17)
