[@hiveio/wax](../globals) / WaxMalformedJsonError

# Class: WaxMalformedJsonError\<T\>
...
### new WaxMalformedJsonError()

> **new WaxMalformedJsonError**\<`T`\>(`request`, `response`): [`WaxMalformedJsonError`](./WaxMalformedJsonError)\<`T`\>
...
[`WaxMalformedJsonError`](./WaxMalformedJsonError)\<`T`\>
...
[wasm/lib/detailed/healthchecker/errors.ts:39](https://gitlab.syncad.com/hive/wax/-/blob/1a548f19544207255a9a9b26ad3f975a5118c6ac/ts/wasm/lib/detailed/healthchecker/errors.ts#L39)
